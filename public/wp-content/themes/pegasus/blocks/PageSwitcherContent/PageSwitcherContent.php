...
if (!class_exists(PageSwitcherContent::class)) {
    /**
     * Class PageSwitcherContent
     * @author <Pegasus>
     * @package Gutenberg\PageSwitcherContent
     */
    class PageSwitcherContent extends BaseBlock
    {
        /**
        ...
        */
        ...
        {
            $filesName = realpath(static::getPath() . '/../') . 'group_6745a1e2144de.json';
