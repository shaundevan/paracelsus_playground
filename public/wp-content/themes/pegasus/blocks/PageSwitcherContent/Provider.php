<?php
namespace Gutenberg\PageSwitcherContent;

use Gutenberg\PageSwitcherContent\PageSwitcherContent;
use Plugandplay\Pegasus\Core\AbstractProvider;;

/**
 * Class Provider
 * @author <Pegasus>
 * @package Gutenberg\PageSwitcherContent;
 */
class Provider extends AbstractProvider
{
    ...
    {
        return [
            'PageSwitcherContent' => PageSwitcherContent::class,
        ];
    }
