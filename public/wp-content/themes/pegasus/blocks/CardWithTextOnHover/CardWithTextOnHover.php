...
if (!class_exists(CardWithTextOnHover::class)) {
    /**
     * Class CardWithTextOnHover
     * @author <Pegasus>
     * @package Gutenberg\CardWithTextOnHover
     */
    class CardWithTextOnHover extends BaseBlock
    {
        /**
        ...
        */
        ...
        {
            $filesName = realpath(static::getPath() . '/../') . 'group_673b64c22249c.json';
