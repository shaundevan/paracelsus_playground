<?php
namespace Gutenberg\CardWithTextOnHover;

use Gutenberg\CardWithTextOnHover\CardWithTextOnHover;
use Plugandplay\Pegasus\Core\AbstractProvider;;

/**
 * Class Provider
 * @author <Pegasus>
 * @package Gutenberg\CardWithTextOnHover;
 */
class Provider extends AbstractProvider
{
    ...
    {
        return [
            'CardWithTextOnHover' => CardWithTextOnHover::class,
        ];
    }
