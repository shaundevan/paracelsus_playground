<?php
namespace Gutenberg\TwoColumnBanner;

use Gutenberg\TwoColumnBanner\TwoColumnBanner;
use Plugandplay\Pegasus\Core\AbstractProvider;;

/**
 * Class Provider
 * @author <Pegasus>
 * @package Gutenberg\TwoColumnBanner;
 */
class Provider extends AbstractProvider
{
    ...
    {
        return [
            'TwoColumnBanner' => TwoColumnBanner::class,
        ];
    }
