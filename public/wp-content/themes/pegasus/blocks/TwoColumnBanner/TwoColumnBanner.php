...
if (!class_exists(TwoColumnBanner::class)) {
    /**
     * Class TwoColumnBanner
     * @author <Pegasus>
     * @package Gutenberg\TwoColumnBanner
     */
    class TwoColumnBanner extends BaseBlock
    {
        /**
        ...
        */
        ...
        {
            $filesName = realpath(static::getPath() . '/../') . 'group_673b25c5df897.json';
