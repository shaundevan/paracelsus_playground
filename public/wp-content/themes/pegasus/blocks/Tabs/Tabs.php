...
if (!class_exists(Tabs::class)) {
    ...
    class Tabs extends BaseBlock
    {
        ...
        */
        ...
        {
            $filesName = realpath(static::getPath() . '/../') . 'group_67502c323e4c0.json';
        ...
        */
        ...
        {
            $tabs = apply_filters('PegasusTabsId', '');

            add_filter('PegasusTabsId', function() { return ''; });

            $this->addData(['tabs' => $tabs]);
