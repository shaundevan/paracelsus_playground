...
if (!class_exists(SingleQuote::class)) {
    /**
     * Class SingleQuote
     * @author <Pegasus>
     * @package Gutenberg\SingleQuote
     */
    class SingleQuote extends BaseBlock
    {
        /**
        ...
        */
        ...
        {
            $filesName = realpath(static::getPath() . '/../') . 'group_6748447218fa7.json';
        ...
        */
        ...
        public function inflate(): void
        {
            if (!empty($this->data['quote'])) {
                $this->addData(['item' => Timber::get_post($this->data['quote']) ]);
            }
